  ...
  let Discord = require('discord.js');
   ...
   userlist.then(collection =>
   {
     if(collection.first() == null)
     {
       ...
       .setTitle(`<a:100:601527835890286612> Banlanan Kullanıcı bulunamadı <a:100:601527835890286612>`)
       .setColor("RED");
     ...
     {
       const embed = new Discord.RichEmbed()
       .setTitle("<a:ylns:601527835890286612> Ban Listesi: Sunucudan Banlananlar.")
       .setColor("RED");
