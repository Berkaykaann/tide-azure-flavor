...
exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    .setColor(0x00AE86)
    .setTimestamp()
    .setImage("https://media.giphy.com/media/KeWBo79fq3MwjhhGzV/giphy.gif")
    .addField('**Eylem**:', 'SIRIUS Hava Yolları İyi Uçuşlar Diler! :bangbang: ')
    ...
    .addField('**Yasaklama Sebebi**:', reason); return guild.channels.get(modlog.id).send(embed);
};
exports.conf = {
  enabled: true,
  guildOnly: true,
